 ...
 * @author gbornia
 */
public class Multiply extends Command implements Function {
        ...
        if (args.length > 1 && context != null) {
            ...
            if (args[0] instanceof Variable && args[1] != this) {
                ...
                try {
                   ...
                   context.logError("Multiply", "Error multiplying the number " + value, e);
                }               
            }
    ...
    public void validateArguments() throws CommandArgumentException {
        ...
        if (args.length < 2)
            throw new CommandArgumentException("Not enough arguments, multiplication needs at least two");
        
        if (args[0]!=null && !(args[0] instanceof Variable))
            throw new CommandArgumentException("The first argument of the multiplication should be a variable");
    }
