 ...
 * @author gbornia
 */
public class Sin extends Command implements Function {
        ...
        if (args.length > 0 && context != null) {
            ...
            if (args[0] != null) {
                ...
                try {
                   ...
                   context.logError("Sin", "Error calculating sin value of " + value, e);
                }               
            }
    ...
    public void validateArguments() throws CommandArgumentException {
        ...
        if (args.length == 0 || args.length > 1)
            throw new CommandArgumentException("The sin command needs only one argument");
